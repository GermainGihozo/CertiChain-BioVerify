...
import { Settings as SettingsIcon, User, Lock, Wallet, Save, Eye, EyeOff } from "lucide-react";
...
export default function Settings() {
  ...
  const handleWalletUpdate = async (e) => {
    ...
    if (!/^0x[a-fA-F0-9]{40}$/.test(walletForm.walletAddress)) {
    ...
    setLoading(true);
    try {
      await api.put("/auth/update-wallet", { walletAddress: walletForm.walletAddress });
    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      {activeTab === "wallet" && (
        <div className="card">
          ...
          <form onSubmit={handleWalletUpdate} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
              ...
              <p className="text-xs text-gray-400 mt-1">
                This wallet will be used for certificate ownership verification
              </p>
            </div>
            ...
            {user?.walletAddress && (
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                ...
                <p className="text-xs font-mono text-blue-700 dark:text-blue-400 break-all">
                  {user.walletAddress}
                </p>
              </div>
            )}
